...
Usage:
    python status.py                  # toate pietele (RO + UK + UK_B2B)
    python status.py --market ro      # doar Romania
    python status.py --market uk      # doar UK consumer
    python status.py --market uk_b2b  # doar UK B2B
...
MARKETS = {
    ...
    "uk": {
        "db":    "hybridking_uk.db",
        "csv":   "outreach_uk.csv",
        "label": "UK - gumtree.com",
    },
    "uk_b2b": {
        "db":    "hybridking_uk_b2b.db",
        "csv":   "outreach_uk_b2b.csv",
        "label": "UK B2B - companies house",
    },
}
...
def main() -> None:
    ...
    parser.add_argument(
        "--market", choices=["ro", "uk", "uk_b2b", "all"], default="all",
    ...
    markets_shown = (
        ["ro", "uk", "uk_b2b"] if args.market == "all"
        else [args.market]
    )
