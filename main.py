...
=========================================================
Suporta trei piete independente:
    python main.py --market ro       # Romania: olx.ro
    python main.py --market uk       # UK consumer: gumtree.com
    python main.py --market uk_b2b   # UK B2B: companies house + email

Fiecare piata = DB separat + CSV separat + log separat.
WhatsApp auto-send = DEZACTIVAT. Trimiti tu manual (RO/UK consumer).
UK B2B foloseste email, nu WhatsApp (vezi email_composer.py).
"""
import argparse
import os
import sys
